...
const Skills = () => {
  return (
    <section id='skills'>
        ...
        <span className="skillDesc">I am a skilled MERN Stack Developer proficient in designing user-friendly web interfaces and proficient in Android Studio for mobile app development. My focus is on creating visually appealing, user-centered solutions that stay up-to-date with industry trends. I excel at bridging design and code to deliver high-quality digital experiences.</span>
